        ...
        var msgObj = {
            ...
            func: {
                ...
                createMessageBox: function () {     // to create message box
                    msgObj.obj.$msgBox = $('<div id="label-alert"></div>').addClass(opt.cl.messageBox).addClass('alert alert-' + opt.type).attr('role', 'alert');
                ...
                createCloseButton: function () {    // to add close button
                    if (opt.close) {
                        ...
                        $('<span></span>').addClass('fa fa-close').appendTo(msgObj.obj.$closeButton);
