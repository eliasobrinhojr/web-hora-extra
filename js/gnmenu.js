...
'use strict';
        ...
        this.trigger = this.el.querySelector('a.gn-icon-menu');
                ...
                var self = this;
                        if (!mobilecheck()) {
                this.trigger.addEventListener('mouseup', function(ev) { self._openIconMenu(); });
                        this.trigger.addEventListener('mouseup', function(ev) { self._closeIconMenu(); });
                ...
                if (this.isMenuOpen) return;
                        ...
                        classie.add(this.menu, 'show-menu');
                        this._closeIconMenu();
                },
                _closeMenu : function() {
                if (!this.isMenuOpen) return;
